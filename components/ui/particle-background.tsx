...
export const ParticleBackground: React.FC = () => {
    ...
    const initParticles = useCallback((width: number, height: number) => {
        ...
        for (let i = 0; i < bgCount; i++) {
            newBgParticles.push({
                ...
                alpha: randomRange(0.05, 0.15), // Darker stars (was 0.1-0.4)
    ...
    const animate = useCallback((time: number) => {
        ...
        const pulseOpacity = Math.sin(time * pulseSpeed) * 0.02 + 0.04; // Darker glow (was 0.035 + 0.085)
    ...
    useEffect(() => {
        ...
        document.addEventListener('mouseleave', handleMouseLeave); // Handle leaving the window
